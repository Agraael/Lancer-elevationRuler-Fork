...
export class MovePenalty {
   ...
   */
  movementCostForSegment(startCoords, endCoords, costFreeDistance = 0, forceGridPenalty, segmentIndex) { // eslint-disable-line default-param-last
  ...
  /** @type {object|undefined} */
  static get terrainHeightToolsAPI() { return OTHER_MODULES.TERRAIN_HEIGHT_TOOLS.API; }
